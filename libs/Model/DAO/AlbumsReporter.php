<?php
/**
 * This is an example Reporter based on the Albums object.  The reporter object
...
class AlbumsReporter extends Reporter
{
	...
	*/
	...
	{
		$sql = "select sum(1) as RecordCount from `albums`";
		return $sql;
	}
}
