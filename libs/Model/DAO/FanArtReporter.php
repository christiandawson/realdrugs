<?php
/**
 * This is an example Reporter based on the FanArt object.  The reporter object
...
class FanArtReporter extends Reporter
{
	...
	*/
	...
	{
		$sql = "select sum(1) as RecordCount from `fan_art`";
		return $sql;
	}
}
