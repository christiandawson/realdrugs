<?php
/**
 * This is an example Reporter based on the Songs object.  The reporter object
...
class SongsReporter extends Reporter
{
	...
	*/
	...
	{
		$sql = "select sum(1) as RecordCount from `songs`";
		return $sql;
	}
}
